...
OPTIONS: dict[str, tuple[Opt, ...]] = {
    "run": (
        ...
        Opt(dest="speculative_review", kind="flag", flag="--no-speculative-review", negates=True),
        ...
        Opt(dest="reviewer_model", kind="value", flag="--reviewer-model"),
        Opt(dest="effort", kind="choice", flag="--effort",
